...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>IdeaPhotography.lk Blog</title>
    ...
    <header class="s-header header">
        ...
        <div class="header__logo ">
            ...
            <a class="logo" href="index.php">
               <a  href="index.php"><img src="images/other/logo.png"  alt="Homepage"></a>
            </a>
        </div> <!-- end header__logo -->

        <a class="header__search-trigger" href="#0"></a>
        <div class="header__search" style="background: hsla(0,0%,100%,1.00)">
